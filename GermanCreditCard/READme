...
This project aims to analyze customer credit behavior using the German Credit dataset. It includes exploratory data analysis (EDA), missing value handling, risk segmentation, and 
clustering to uncover patterns that can inform credit risk strategies.
